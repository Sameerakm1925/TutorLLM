...
1. Clone the repository:
   ...
   ```shell
   git clone https://github.com/Sameerakm1925/TutorLLM.git
   ```
...
* [Figma Design Files](https://www.figma.com/file/xSUUeK3lB9XHqBe3pg7pnM/TutorLLM?type=design&node-id=84%3A7156&t=uJ3S7XQV7OjJphmL-1)
