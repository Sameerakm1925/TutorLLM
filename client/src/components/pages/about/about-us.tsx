...
const AboutUs: React.FC = () => {
  return (
    <div className=" p-12">
      <h1 className="text-3xl ml-5 font-semibold mb-4">About TutorLLM</h1>
      <div className="flex flex-col md:flex-row space-x-0 md:space-x-8">
        ...
        <div className="md:w-1/2 mt-5 md:mt-0">
          <p className="text-gray-600 mb-4">
            Welcome to TutorLLM, your ultimate destination for online learning
          ...
          <p className="text-gray-600 mb-4">
            ...
            advancing your career, TutorLLM provides you with a dynamic learning
            experience that fits your schedule.
          </p>
          <p className="text-gray-600 mb-4">
          ...
          <p className="text-gray-600">
            Join TutorLLM today and embark on a journey of knowledge,
