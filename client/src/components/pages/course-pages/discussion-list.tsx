  ...
  return (
    <li className='border-b mt-3 border-gray-300 p-6'>
      <div className='flex justify-between items-start'>
        <div className='flex'>
          <img className='w-12 h-12 rounded-full object-cover' src={studentDetails?.profilePic?.url || profilePic} alt='image' />
          <div className='ml-2'>
                      ...
                      <div className='flex justify-between items-start'>
                        <div className='flex'>
                          <img
                            ...
                            src={reply?.userDetails?.profilePic?.url || profilePic}
                            alt='image'
                          />
                          <div className='ml-2'>
                            <h2 className='font-semibold text-customFontColorBlack'>
                              {reply?.userDetails?.firstName +
                                " " +
