...
const LazyOnboarding = lazy(
  () => import("./components/pages/onboarding/OnboardingFlow"),
);

const LazyRecommendedPath = lazy(
  () => import("./components/pages/student-dash/RecommendedPath"),
);

const LazyAIWatchLesson = lazy(
  () => import("./components/pages/course-pages/AIWatchLesson"),
);

const LazyCourseProgress = lazy(
  () => import("./components/pages/student-dash/CourseProgress"),
);
...
const LazySettings = lazy(
  () => import("./components/pages/student-dash/settings"),
);
...
const LazyStudentQuestions = lazy(
  () => import("./components/pages/add-lesson/student-questions"),
);
...
const AppRouter = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "view-lessons/:courseId/questions/:lessonId",
        element: (
          <Suspense fallback={<div>Loading...</div>}>
            <LazyStudentQuestions />
          </Suspense>
        ),
      },
      {
