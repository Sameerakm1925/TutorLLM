...
const EditLessonForm: React.FC = () => {
  ...
  useEffect(() => {
    if (lessonInfo) {
      ...
      initialValues.videoUrl = (lessonInfo as any).videoUrl ?? "";
                  ...
                  <div className="w-1/2">
                    ...
                    <div className="mt-2">
                      <Field
                        ...
                        rows={4}
                        cols={40}
                        className="pl-2 block w-full max-w-xl rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-700 sm:text-sm sm:leading-6"
                      />
                      <ErrorMessage
                        name="contents"
                        component="div"
