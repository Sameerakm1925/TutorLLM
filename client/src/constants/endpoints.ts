const END_POINTS = {
    ...
    GET_UNVERIFIED_COURSES: "api/admin/unverified-courses",
    VERIFY_COURSE: "api/admin/verify-course",
    ONBOARDING: "api/students/onboarding",
    ADAPT_PATH: "api/students/adapt-path",
    SUBMIT_QUIZ: "api/courses/submit-quiz"
}
